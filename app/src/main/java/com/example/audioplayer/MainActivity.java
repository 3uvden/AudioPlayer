...
public class MainActivity extends AppCompatActivity implements Runnable{
            ...
            switch (view.getId()) {
                ...
                case R.id.fabRepeat:
                    if (!isRepeat) {
                        ...
                        fabRepeat.setImageDrawable(ContextCompat.getDrawable(MainActivity.this, R.id.drawable.repeat));
                        break;
                    } else {
                        mediaPlayer.setLooping(false);

                        fabRepeat.setImageDrawable(ContextCompat.getDrawable(MainActivity.this, R.id.repeat_off ));
                        isRepeat = false;
                    }
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fabPlayPause = findViewById(R.id.fabPlayPuse);
    ...
    public void playSong() {
        try {
            ...
            if (wasPlaying) {
                ...
                AssetFileDescriptor descriptor = getAssets().openFd("Айдамир Мугу - Чёрные глаза.mp3");
